...
class Checkout{
                    ...
                    if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                        ...
                        <li class=" <?php echo esc_attr( apply_filters( 'wrech_mini_cart_item_class', 'wrech_mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
                            ...
                            <?php echo "<div class='wrech-col wrech-col-7'>
                                            ...
                                            <div class='wrech_quantity_wrapper'>
                                                <span class='wrech-change-quantity wrech-quantity-decrease'><img src='".WRECH_PLUGIN_URL . 'assets/images/line.png'."' alt='-'></span>
                                                <input min='0' data-cart_item_key='".$cart_item_key."' type='number' class='wrech-quantity' value='" .$cart_item['quantity']. "' >
                                                <span class='wrech-change-quantity wrech-quantity-increase'><img src='".WRECH_PLUGIN_URL . 'assets/images/plus1.png'."' alt='+'></span>
                                            </div>
                                        </div>"; ?>
    ...
    public static function field_operations($fields){
        ...
        if(!self::is_checkout()){
            ...
            $fields = apply_filters( 'wrech_fields', $fields, $woo_fields );
        }
	...
	public static function checkout_form($checkout){
        ...
        $checkout->checkout_fields = self::field_operations($fields);
		...
		<form name="checkout" method="post" class="wrech-checkout checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
			...
			<?php if ( $checkout->get_checkout_fields() ) : ?>
				...
				<?php do_action( 'wrech_woocommerce_checkout_before_customer_details' ); ?>

				<div class="wrech-step wrech-step-info" id="customer_details">
					<div class="customer-details-section">
						<?php do_action( 'wrech_woocommerce_checkout_billing' ); ?>
					</div>
