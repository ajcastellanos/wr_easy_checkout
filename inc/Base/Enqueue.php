...
class Enqueue{
    ...
    function wrech_enqueue_frontend(){
        ...
        if(!Checkout::is_checkout()){
	       ...
	       // wp_add_inline_style( 'main-css', array($this, 'dynamic_settings_styles') );
	        ...
	        wp_enqueue_script('wrech-main-js', WRECH_PLUGIN_URL  . '/assets/js/main.js' ,array('jquery','swiper-js','customizer'),'1.0', true);
	        ...
	        $args = array(
                ...
                'required_fields' => wrech_checkout_mandatory_fields(Checkout::checkout())
	        );
	...
	/**
	 * Remaining styles theme mod which can be inserted bi kirki css module
	 */
