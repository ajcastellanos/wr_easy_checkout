...
class Settings{
    ...
    public function register(){
	    ...
	    add_action( 'customize_preview_init', array($this, 'customizer_load'), 10, 1 );

        //add_action( 'customize_save_after', function($manager) {}, 10 , 1 );
	...
	/**
	 * Enqueue js to the customizer in order to avoid the modal natural interations
	 */
    function customizer_load($manager ){


        wp_enqueue_script('wrech-customizer', WRECH_PLUGIN_URL  . '/assets/js/customizer.js' ,array('jquery'),'1.0', true);
